...
<div class="wrapper">
  ...
  <a href="../../home/index" class="logo">
      ...
      <span class="logo-mini"><b>L</b>CSU</span>
      <!-- logo for regular state and mobile devices -->
        <img src="../../../img/logo.png" class="user-image" alt="User Image" height="50" width="50">
 ...
 <li class="dropdown messages-menu <?php echo (currentpage_admin()=='index') ? 'active':''?>">
            <a href="../../home/index">
              <i>HOME</i>
            </a>
          </li>
 ...
 <li class="dropdown messages-menu <?php echo (currentpage_admin()=='pretest') ? 'active':''?>">
            <a href="../../assessments/pretest">
              <i>MCQ</i>
            </a>
          </li>

           <li class="dropdown messages-menu <?php echo (currentpage_admin()=='examproper') ? 'active':''?>">
           <a href="../../assessments/examproper/">
              <i>FINAL EXAM</i>
            </a>
          </li>

           <li class="dropdown messages-menu <?php echo (currentpage_admin()=='results') ? 'active':''?>">
